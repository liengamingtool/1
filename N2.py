...
def banner():
 ...
 banner = f"""
 \033[1;36m   _        _____   ______   _   _      _____              __  __   _____   _   _    _____ 
 \033[1;32m  | |      |_   _| |  ____| | \ | |    / ____|     /\     |  \/  | |_   _| | \ | |  / ____|  
 \033[1;32m  | |        | |   | |__    |  \| |   | |  __     /  \    | \  / |   | |   |  \| | | |  __   
 \033[1;33m  | |        | |   |  __|   | . ` |   | | |_ |   / /\ \   | |\/| |   | |   | . ` | | | |_ |  
 \033[1;35m  | |____   _| |_  | |____  | |\  |   | |__| |  / ____ \  | |  | |  _| |_  | |\  | | |__| |  
 \033[1;35m  |______| |_____| |______| |_| \_|    \_____| /_/    \_\ |_|  |_| |_____| |_| \_|  \_____|  
 
 
\033[1;31m────────────────────────────────────────────────────────────
\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;33mTOOL AUTO TRAO ĐỔI SUB FACEBOOK VIP 
\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;36m XIN CHÀO !!
\033[1;31m────────────────────────────────────────────────────────────
"""
 for X in banner:
  sys.stdout.write(X)
...
class Facebook_Api (object):
	...
	def share(self, id, nd="Thành Pro"):
		try:
			url = requests.get('https://mbasic.facebook.com/'+id, headers=self.headers).url
...
def error(id, type):
	time=datetime.now().strftime("%H:%M:%S")
	uid = id.split('_')[1] if '_' in id else id
	print(f'\033[1;31m Vui Lòng Đổi Acc Mới Để Chạy !! ', end = '\r'); sleep(2); print('                                                   ', end = '\r')
...
def main():
	...
	print('\033[1;31m────────────────────────────────────────────────────────────')
	print('\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mChọn Nhiều Nhiệm Vụ (VD :  123...)')
